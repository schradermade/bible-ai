...
export default function DailyPanel({
  ...
  const defaultContent = {
    ...
    prayer:
      "Heavenly Father, thank You for inviting me to cast my anxieties upon You. Help me to trust in Your sovereignty and rest in Your peace. Guard my heart and mind as I navigate today's challenges. Amen.",
    actionStep:
      'Take 5 minutes today to write down your worries, then intentionally pray through each one, releasing them to God.',
  };
    ...
    return (
      <div className={styles.dailyPreview}>
        <div className={styles.previewContent}>
          <div className={styles.previewLabel}>Daily Devotional</div>
        </div>
  ...
  return (
    <div ref={panelRef} className={styles.dailyPanel}>
      ...
      >
        <h2 className={styles.panelTitle}>Daily Devotional</h2>
        <div className={styles.panelSubtitle}>Daily Devotional Reflection</div>
      </div>
      ...
      <div className={styles.contentSection}>
        ...
        <div className={styles.scriptureReference}>
          {displayContent.scripture.reference}
        </div>
        <p className={styles.scriptureText}>
          "{displayContent.scripture.text}"
        </p>
      </div>
